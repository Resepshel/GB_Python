...
def mul_and_div(mass):
    ...
    if index_mul < index_div:
        mass = calculate_simple.mul(mass, index_mul)
    else:
        mass = calculate_simple.div(mass, index_div)
...
def sum_and_sub(mass):
    ...
    if index_sum < index_sub:
        mass = calculate_simple.sum(mass, index_sum)
    else:
        mass = calculate_simple.sub(mass, index_sub)
